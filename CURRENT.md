...
| Baseline agent/skill plugin install verification | #65, #82 | Catalog discovery is implemented, but the full Copilot CLI install-and-delegate smoke path still needs broader CI coverage. |
